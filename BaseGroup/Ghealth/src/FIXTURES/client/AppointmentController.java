...
public class AppointmentController extends ActionFixture {
	...
	public void doctorType(String doctorType) {

		this.doctorsAndClinics = newApp_ctrl.GET_DOCTOR_CLINIC(pt.getpID(),DoctorSpeciallity.valueOf(doctorType));
	...
	public void clinicIDAndDoctor(int clinicIDAndDoctor) {
		
		as.setApsDocID(doctorsAndClinics.get(clinicIDAndDoctor).toString());
